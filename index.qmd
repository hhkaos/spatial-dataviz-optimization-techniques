...
Quería contaros cómo fue mi primera experiencia (o drama) que acontenció por estas fechas hacer 10 años, marzo/abril de 2014. Nada más empezar mi nuevo trabajo en Esri, se acercó mi jefe muy emocionado y me dijo... Raúl, el responsable de marketing ha hablado con la gente de El País, el periódico, y vamos a hacer una Geoporra para la final de la Champions League del mes que viene (Madrid - Atlético) ...
:::
...
Yo nuevo en mapas, vamos a crear unos índices espaciales, postgres.... petaba

Bueno Periódico, página de clasificados, b2b, agencias
:::
...
* 10 años de [GeoDevelopers.org](https://www.geodevelopers.org/) 🗺️🌍
...
::: {.notes}
FPS
Visor web usando &lt;svg&gt; para pintar ~35K municipios de Francia <br/>(45MB de JSON; +2M vértices)
:::
...
## Si pudiese viajar en el tiempo... { background-image=""  background-size="cover"}

Habría:

::: {.incremental}
* Troceado usando _feature layers_ (no imágenes en servidor)
* Usado clusters (no puntos)
* Habría usado caché (_near real-time_)
