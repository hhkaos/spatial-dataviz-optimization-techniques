...
::: {.notes}
Quería empezar contandoos algo que me pasó por estas fechas hacer 10 años,marzo/abril de 2014, nada más empezar mi nuevo trabajo en mapas. Se acercaba la final de la champios league (Madrid - Atlético) ...
:::

## 24/05/14 {.center-title-slide .smallerTitle}
...
# ¿Qué podemos optimizar? {.strongBg background-image="./imgs/leaflet-large-dataset-plain-blur.png"  background-size="cover"}
...
![](./imgs/basemaps-pricing-models.png)

> **Fuente**: [Intro a los mapas base y ArcGIS Basemaps (v2)](https://www.youtube.com/watch?v=SBf8d6PeJMQ&t=613s)
...
<iframe src="https://www.ign.es/iberpix/visor/" style="width:100%;height:520px"></iframe>
...
# TIEMPOS DE CARGA{.strongBg background-image="./imgs/title-loading-times.png"  background-size="cover"}
...
* Analisis en cliente = _Client-side analysis_ 📏📐
...
::: {.center-xy}
[x.com/hhkaos](https://x.com/hhkaos) | [linkedin.com/in/jimenezortegaraul/](https://linkedin.com/in/jimenezortegaraul/)
